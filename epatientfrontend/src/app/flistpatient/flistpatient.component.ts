...
@Component({
  selector: 'app-flistpatient',
  templateUrl: './flistpatient.component.html',
  styleUrls: ['./flistpatient.component.css']
})
export class FListpatientComponent implements OnInit {
